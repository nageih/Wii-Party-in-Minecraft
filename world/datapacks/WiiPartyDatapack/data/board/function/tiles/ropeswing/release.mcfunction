...
execute if entity @a[tag=turn,team=blue] run tellraw @a[tag=playing] [{"translate":"board.Tiles.RopeSwing.Rolled","color":"gray","with":[{"selector":"@a[tag=turn]","color":"#0088FF"},{"score":{"name":"eventRoll=","objective":"diceRoll"},"color":"gray","bold":true}]}]
execute if entity @a[tag=turn,team=red] run tellraw @a[tag=playing] [{"translate":"board.Tiles.RopeSwing.Rolled","color":"gray","with":[{"selector":"@a[tag=turn]","color":"red"},{"score":{"name":"eventRoll=","objective":"diceRoll"},"color":"gray","bold":true}]}]
execute if entity @a[tag=turn,team=green] run tellraw @a[tag=playing] [{"translate":"board.Tiles.RopeSwing.Rolled","color":"gray","with":[{"selector":"@a[tag=turn]","color":"green"},{"score":{"name":"eventRoll=","objective":"diceRoll"},"color":"gray","bold":true}]}]
execute if entity @a[tag=turn,team=orange] run tellraw @a[tag=playing] [{"translate":"board.Tiles.RopeSwing.Rolled","color":"gray","with":[{"selector":"@a[tag=turn]","color":"gold"},{"score":{"name":"eventRoll=","objective":"diceRoll"},"color":"gray","bold":true}]}]
