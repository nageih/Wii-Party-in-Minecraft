...
title @a[tag=playing,tag=!ingame] subtitle {"translate":"board.Tiles.SpikeBall.Win","color":"light_purple","bold":true}
title @a[tag=ingame,team=blue] subtitle {"translate":"board.Tiles.SpikeBall.Win","color":"#0088FF","bold":true}
title @a[tag=ingame,team=red] subtitle {"translate":"board.Tiles.SpikeBall.Win","color":"red","bold":true}
title @a[tag=ingame,team=green] subtitle {"translate":"board.Tiles.SpikeBall.Win","color":"green","bold":true}
title @a[tag=ingame,team=orange] subtitle {"translate":"board.Tiles.SpikeBall.Win","color":"gold","bold":true}
