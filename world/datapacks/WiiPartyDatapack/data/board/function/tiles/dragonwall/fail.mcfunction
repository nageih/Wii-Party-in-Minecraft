...
title @a[tag=playing,tag=!ingame] subtitle {"translate":"board.Tiles.Dragon.Fail","color":"light_purple","bold":true}
title @a[tag=ingame,team=blue] subtitle {"translate":"board.Tiles.Dragon.Fail","color":"#0088FF","bold":true}
title @a[tag=ingame,team=red] subtitle {"translate":"board.Tiles.Dragon.Fail","color":"red","bold":true}
title @a[tag=ingame,team=green] subtitle {"translate":"board.Tiles.Dragon.Fail","color":"green","bold":true}
title @a[tag=ingame,team=orange] subtitle {"translate":"board.Tiles.Dragon.Fail","color":"gold","bold":true}
