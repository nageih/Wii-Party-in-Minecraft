...
title @a[tag=playing,tag=!ingame] subtitle {"translate":"board.Tiles.Dragon.Win","color":"light_purple","bold":true}
title @a[tag=ingame,team=blue] subtitle {"translate":"board.Tiles.Dragon.Win","color":"#0088FF","bold":true}
title @a[tag=ingame,team=red] subtitle {"translate":"board.Tiles.Dragon.Win","color":"red","bold":true}
title @a[tag=ingame,team=green] subtitle {"translate":"board.Tiles.Dragon.Win","color":"green","bold":true}
title @a[tag=ingame,team=orange] subtitle {"translate":"board.Tiles.Dragon.Win","color":"gold","bold":true}
execute at @a[tag=turn] run playsound minecraft:block.note_block.iron_xylophone master @a ~ ~ ~ 20 0.5 1
scoreboard players set dragonAlive= tiles 0
