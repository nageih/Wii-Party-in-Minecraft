...
title @a[tag=playing,tag=!ingame] subtitle {"translate":"tiles.Dragon.Win","color":"light_purple","bold":true}
title @a[tag=ingame,team=blue] subtitle {"translate":"tiles.Dragon.Win","color":"#0088FF","bold":true}
title @a[tag=ingame,team=red] subtitle {"translate":"tiles.Dragon.Win","color":"red","bold":true}
title @a[tag=ingame,team=green] subtitle {"translate":"tiles.Dragon.Win","color":"green","bold":true}
title @a[tag=ingame,team=orange] subtitle {"translate":"tiles.Dragon.Win","color":"gold","bold":true}
