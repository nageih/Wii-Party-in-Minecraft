...
execute if entity @s[gamemode=adventure,x=-302,y=12,z=114,dx=9,dy=4,dz=2,scores={newBoardPos=1}] run schedule function board:tiles/boost/start 10t append
...
execute if entity @s[gamemode=adventure,x=-287,y=18,z=22,dx=10,dy=4,dz=2,scores={newBoardPos=7}] run schedule function board:tiles/boost/start 10t append
...
execute if entity @s[gamemode=adventure,x=-264,y=14,z=-11,dx=12,dy=4,dz=2,scores={newBoardPos=10}] run schedule function board:tiles/boost/start 10t append
execute if entity @s[gamemode=adventure,x=-271,y=14,z=-22,dx=12,dy=4,dz=2,scores={newBoardPos=11}] run schedule function board:tiles/boost/start 10t append
execute if entity @s[gamemode=adventure,x=-270,y=13,z=-33,dx=15,dy=4,dz=2,scores={newBoardPos=12}] run schedule function board:tiles/boost/start 10t append
...
execute if entity @s[gamemode=adventure,x=-241,y=11,z=-36,dx=-2,dy=4,dz=8,scores={newBoardPos=14}] run schedule function board:tiles/ufo/start 10t append
...
execute if entity @s[gamemode=adventure,x=-217,y=11,z=5,dx=9,dy=4,dz=2,scores={newBoardPos=17}] run schedule function board:tiles/tornado/start 10t append
...
execute positioned -149 10 40 if entity @s[gamemode=adventure,distance=..3.2,scores={newBoardPos=21}] run function board:dice_roll/end_go
...
execute if entity @s[gamemode=adventure,x=-129,y=7,z=35,dx=2,dy=4,dz=9,scores={newBoardPos=23}] run schedule function board:tiles/boost/start 10t append
execute if entity @s[gamemode=adventure,x=-123,y=7,z=44,dx=9,dy=4,dz=2,scores={newBoardPos=24}] run schedule function board:tiles/boost/start 10t append
...
execute if entity @s[gamemode=adventure,x=-171,y=14,z=104,dx=9,dy=4,dz=2,scores={newBoardPos=30}] run schedule function board:tiles/boost/start 10t append
...
execute if entity @s[gamemode=adventure,x=-186,y=23,z=116,dx=2,dy=4,dz=9,scores={newBoardPos=32}] run function board:tiles/dino/start
execute if entity @s[gamemode=adventure,x=-199,y=26,z=110,dx=2,dy=4,dz=9,scores={newBoardPos=33}] run schedule function board:tiles/skull/start 10t append
...
execute if entity @s[gamemode=adventure,x=-244,y=25,z=103,dx=2,dy=4,dz=10,scores={newBoardPos=36}] run schedule function board:tiles/volcano/start 10t append
execute if entity @s[gamemode=adventure,x=-259,y=25,z=96,dx=2,dy=4,dz=12,scores={newBoardPos=37}] run function board:dice_roll/end_go
execute if entity @s[gamemode=adventure,x=-268,y=25,z=87,dx=9,dy=4,dz=2,scores={newBoardPos=38}] run schedule function board:tiles/boost/start 10t append
execute if entity @s[gamemode=adventure,x=-262,y=25,z=78,dx=11,dy=4,dz=2,scores={newBoardPos=39}] run schedule function board:tiles/tornado/start 10t append
execute if entity @s[gamemode=adventure,x=-248,y=28,z=69,dx=2,dy=4,dz=10,scores={newBoardPos=40}] run schedule function board:tiles/boost/start 10t append
...
execute if entity @s[gamemode=adventure,x=-198,y=26,z=12,dx=11,dy=5,dz=2,scores={newBoardPos=47}] run schedule function board:tiles/ufo/start 10t append
...
execute if entity @s[gamemode=adventure,x=-203,y=25,z=-18,dx=8,dy=4,dz=2,scores={newBoardPos=49}] run function board:dice_roll/end_go
...
execute if entity @s[gamemode=adventure,x=-206,y=20,z=-54,dx=2,dy=4,dz=10,scores={newBoardPos=52}] run schedule function board:tiles/boost/start 10t append
execute if entity @s[gamemode=adventure,x=-195,y=20,z=-32,dx=11,dy=4,dz=2,scores={newBoardPos=53}] run schedule function board:tiles/tornado/start 10t append
execute if entity @s[gamemode=adventure,x=-183,y=20,z=-17,dx=10,dy=4,dz=2,scores={newBoardPos=54}] run schedule function board:tiles/boost/start 10t append
...
execute if entity @s[gamemode=adventure,x=-145,y=20,z=-2,dx=2,dy=4,dz=10,scores={newBoardPos=57}] run schedule function board:tiles/boost/start 10t append
...
execute if entity @s[gamemode=adventure,x=-111,y=20,z=26,dx=10,dy=4,dz=2,scores={newBoardPos=60}] run function board:tiles/dino/start
...
execute if entity @s[gamemode=adventure,x=-106,y=17,z=73,dx=10,dy=4,dz=2,scores={newBoardPos=63}] run schedule function board:tiles/boost/start 10t append
...
execute if entity @s[gamemode=adventure,x=-115,y=13,z=92,dx=6,dy=4,dz=2,scores={newBoardPos=65}] run function board:dice_roll/end_go
...
execute if entity @s[gamemode=adventure,x=-129,y=13,z=93,dx=2,dy=4,dz=10,scores={newBoardPos=67}] run schedule function board:tiles/ufo/start 10t append
...
execute if entity @s[gamemode=adventure,x=-136,y=17,z=92,dx=2,dy=4,dz=11,scores={newBoardPos=69}] run schedule function board:tiles/tornado/start 10t append
...
execute if entity @s[gamemode=adventure,x=-160,y=25,z=95,dx=2,dy=4,dz=11,scores={newBoardPos=74}] run schedule function board:tiles/boost/start 10t append
...
execute if entity @s[gamemode=adventure,x=-183,y=28,z=85,dx=2,dy=4,dz=11,scores={newBoardPos=76}] run function board:dice_roll/end_go
execute if entity @s[gamemode=adventure,x=-194,y=30,z=80,dx=2,dy=8,dz=15,scores={newBoardPos=77}] run schedule function board:tiles/boost/start 10t append
...
execute if entity @s[gamemode=adventure,x=-231,y=44,z=71,dx=2,dy=4,dz=8,scores={newBoardPos=81}] run schedule function board:tiles/boost/start 10t append
...
execute if entity @s[gamemode=adventure,x=-232,y=53,z=49,dx=10,dy=4,dz=2,scores={newBoardPos=84}] run schedule function board:tiles/skull/start 10t append
execute if entity @s[gamemode=adventure,x=-226,y=54,z=39,dx=10,dy=4,dz=2,scores={newBoardPos=85}] run schedule function board:tiles/tornado/start 10t append
...
execute if entity @s[gamemode=adventure,x=-200,y=57,z=41,dx=10,dy=4,dz=2,scores={newBoardPos=88}] run schedule function board:tiles/ufo/start 10t append
execute if entity @s[gamemode=adventure,x=-197,y=57,z=47,dx=10,dy=4,dz=2,scores={newBoardPos=89}] run schedule function board:tiles/boost/start 10t append
