...
advancement revoke @s only games:26/hit_sus

# Increases player total points by 3, since it is a golden one
scoreboard players remove @s 26points 3

execute if score @s 26points matches ..-1 run scoreboard players set @s 26points 0
