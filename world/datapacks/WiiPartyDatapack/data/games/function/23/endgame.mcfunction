...
schedule function games:23/end 5s
...
# Everyone who hasnt been placed yet must be the last alive
tag @a[tag=ingame,tag=!23placed] add 1st

# Runs the function that shows where the players placed
function general:placements

scoreboard players reset choosing= 23scores
