data merge entity @e[type=glow_item_frame,tag=23rail,distance=..0.25,limit=1] {ItemRotation:2b,Item:{id:"minecraft:rail",count:1,components:{"minecraft:custom_model_data":9}}}
...
execute positioned ~3 ~ ~-3 run clone 24011 27 23990 24010 28 23988 ~ ~ ~
