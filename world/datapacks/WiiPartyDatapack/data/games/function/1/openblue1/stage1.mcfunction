fill 1007 240 1005 1001 240 1005 minecraft:air
...
schedule function games:1/openblue1/stage2 3t
execute positioned 1004 241 1000 run playsound minecraft:entity.blaze.hurt master @a ~ ~ ~ 10 0.5