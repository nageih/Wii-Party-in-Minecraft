...
scoreboard players operation max= 1score > @a[tag=ingame] 1score
...
execute as @a[tag=ingame] if score @s 1score = max= 1score run tag @s add 1st
execute as @a[tag=ingame] if score @s 1score = max= 1score run tag @s add scored
