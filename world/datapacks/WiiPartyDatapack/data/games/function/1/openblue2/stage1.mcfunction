fill 1007 191 1005 1001 191 1005 minecraft:air
...
schedule function games:1/openblue2/stage2 3t
execute positioned 1004 192 1000 run playsound minecraft:entity.blaze.hurt master @a ~ ~ ~ 10 0.5