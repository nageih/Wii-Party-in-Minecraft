...
execute as @a[tag=ingame,team=blue] if score @s 35step matches 12 run team modify displayline11 prefix {"translate":"scoreboard.StrategySteps","bold":true,"with":[{"translate":"scoreboard.StrategySteps.Symbols.12","color":"#0088ff"},{"translate":"scoreboard.StrategySteps.Symbols.0","color":"gray"}]}
    # Red team
...
execute as @a[tag=ingame,team=red] if score @s 35step matches 12 run team modify displayline8 prefix {"translate":"scoreboard.StrategySteps","bold":true,"with":[{"translate":"scoreboard.StrategySteps.Symbols.12","color":"red"},{"translate":"scoreboard.StrategySteps.Symbols.0","color":"gray"}]}
    # Green team
...
execute as @a[tag=ingame,team=green] if score @s 35step matches 12 run team modify displayline5 prefix {"translate":"scoreboard.StrategySteps","bold":true,"with":[{"translate":"scoreboard.StrategySteps.Symbols.12","color":"green"},{"translate":"scoreboard.StrategySteps.Symbols.0","color":"gray"}]}
    # Orange team
...
execute as @a[tag=ingame,team=orange] if score @s 35step matches 12 run team modify displayline2 prefix {"translate":"scoreboard.StrategySteps","bold":true,"with":[{"translate":"scoreboard.StrategySteps.Symbols.12","color":"gold"},{"translate":"scoreboard.StrategySteps.Symbols.0","color":"gray"}]}