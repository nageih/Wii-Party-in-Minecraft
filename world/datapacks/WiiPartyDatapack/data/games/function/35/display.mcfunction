...
# Displays specific symbols that represent if the player is dead or alive depending on if they have the 35finished tag
    # Blue team
execute as @a[tag=ingame,team=blue] unless score @s 35step matches 0 run team modify displayline11 prefix {"translate":"scoreboard.StrategySteps","bold":true,"with":[{"translate":"scoreboard.StrategySteps.Symbols.0","color":"gray"},{"translate":"scoreboard.StrategySteps.Symbols.12","color":"gray"}]}
...
execute as @a[tag=ingame,tag=failed,team=blue] unless score @s 35step matches 12 run team modify displayline11 prefix {"translate":"scoreboard.StrategySteps","bold":true,"with":[{"translate":"scoreboard.StrategySteps.Symbols.12","color":"dark_gray"},{"translate":"scoreboard.StrategySteps.Symbols.0","color":"gray"}]}
    # Red team
execute as @a[tag=ingame,team=red] unless score @s 35step matches 0 run team modify displayline8 prefix {"translate":"scoreboard.StrategySteps","bold":true,"with":[{"translate":"scoreboard.StrategySteps.Symbols.0","color":"gray"},{"translate":"scoreboard.StrategySteps.Symbols.12","color":"gray"}]}
...
execute as @a[tag=ingame,tag=failed,team=red] unless score @s 35step matches 12 run team modify displayline8 prefix {"translate":"scoreboard.StrategySteps","bold":true,"with":[{"translate":"scoreboard.StrategySteps.Symbols.12","color":"dark_gray"},{"translate":"scoreboard.StrategySteps.Symbols.0","color":"gray"}]}
    # Green team
execute as @a[tag=ingame,team=green] unless score @s 35step matches 0 run team modify displayline5 prefix {"translate":"scoreboard.StrategySteps","bold":true,"with":[{"translate":"scoreboard.StrategySteps.Symbols.0","color":"gray"},{"translate":"scoreboard.StrategySteps.Symbols.12","color":"gray"}]}
...
execute as @a[tag=ingame,tag=failed,team=green] unless score @s 35step matches 12 run team modify displayline5 prefix {"translate":"scoreboard.StrategySteps","bold":true,"with":[{"translate":"scoreboard.StrategySteps.Symbols.12","color":"dark_gray"},{"translate":"scoreboard.StrategySteps.Symbols.0","color":"gray"}]}
    # Orange team
execute as @a[tag=ingame,team=orange] unless score @s 35step matches 0 run team modify displayline2 prefix {"translate":"scoreboard.StrategySteps","bold":true,"with":[{"translate":"scoreboard.StrategySteps.Symbols.0","color":"gray"},{"translate":"scoreboard.StrategySteps.Symbols.12","color":"gray"}]}
...
execute as @a[tag=ingame,tag=failed,team=orange] unless score @s 35step matches 12 run team modify displayline2 prefix {"translate":"scoreboard.StrategySteps","bold":true,"with":[{"translate":"scoreboard.StrategySteps.Symbols.12","color":"dark_gray"},{"translate":"scoreboard.StrategySteps.Symbols.0","color":"gray"}]}