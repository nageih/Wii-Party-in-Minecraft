...
execute at @e[tag=35prev] positioned ~1 ~-20 ~-20 as @a[tag=ingame,dz=40,dx=-50,dy=40] if score @s 35step > cur= 35step at @s run function games:35/step_tp with storage game35 step
