...
execute at @e[tag=35prev] positioned ~-1 ~-20 ~-20 as @a[tag=ingame,dx=-50,dy=40,dz=40] if score @s 35prev >= cur= 35step at @s run function games:35/step_tp with storage game35 step
