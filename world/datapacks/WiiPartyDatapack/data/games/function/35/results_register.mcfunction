...
execute unless score 1= 35scores matches 1 run tellraw @a[tag=playing] [{"text":"     "},{"translate":"game.StrategySteps.Results.Value","color":"gray","bold": true,"with":[{"selector":"@a[tag=ingame,scores={35num=1}]"},{"text":"1"}]}]
execute unless score 3= 35scores matches 1 run tellraw @a[tag=playing] [{"text":"     "},{"translate":"game.StrategySteps.Results.Value","color":"gray","bold": true,"with":[{"selector":"@a[tag=ingame,scores={35num=3}]"},{"text":"3"}]}]
execute unless score 5= 35scores matches 1 run tellraw @a[tag=playing] [{"text":"     "},{"translate":"game.StrategySteps.Results.Value","color":"gray","bold": true,"with":[{"selector":"@a[tag=ingame,scores={35num=5}]"},{"text":"5"}]}]
tellraw @a[tag=playing] ""

schedule function games:35/travel_start 2s