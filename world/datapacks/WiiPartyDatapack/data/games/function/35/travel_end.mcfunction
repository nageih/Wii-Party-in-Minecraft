...
execute as @a[tag=ingame] run scoreboard players operation @s 35prev = @s 35step

execute unless entity @a[tag=ingame,scores={35step=12..}] run schedule function games:35/start_countdown 2s