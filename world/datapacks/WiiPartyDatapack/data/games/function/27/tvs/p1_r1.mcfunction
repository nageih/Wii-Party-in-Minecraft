...
scoreboard players add p1_r1= 27scores 1
execute if score p1_r1= 27scores matches 5.. run scoreboard players set p1_r1= 27scores 1
# Score = 1
...
function games:27/tvs/check_p1