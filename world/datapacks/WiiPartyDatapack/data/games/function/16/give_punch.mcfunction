...
item replace entity @s[team=blue] weapon.mainhand with crossbow[custom_data={16punch:2},unbreakable={show_in_tooltip:0b},custom_model_data=1,enchantment_glint_override=false,charged_projectiles=[{id:"arrow"}]]
item replace entity @s[team=red] weapon.mainhand with crossbow[custom_data={16punch:2},unbreakable={show_in_tooltip:0b},custom_model_data=3,enchantment_glint_override=false,charged_projectiles=[{id:"arrow"}]]
item replace entity @s[team=green] weapon.mainhand with crossbow[custom_data={16punch:2},unbreakable={show_in_tooltip:0b},custom_model_data=5,enchantment_glint_override=false,charged_projectiles=[{id:"arrow"}]]
item replace entity @s[team=orange] weapon.mainhand with crossbow[custom_data={16punch:2},unbreakable={show_in_tooltip:0b},custom_model_data=7,enchantment_glint_override=false,charged_projectiles=[{id:"arrow"}]]