...
# Displays specific symbols that represent if the player is dead or alive depending on if they have the 16dead tag
    # Blue team
execute as @a[tag=ingame,tag=!16dead,team=blue] run team modify displayline11 prefix {"translate":"scoreboard.TropicalPunch","with":[{"translate":"scoreboard.TropicalPunch.Symbol","color":"gray"}]}
execute as @a[tag=ingame,tag=16dead,team=blue] run team modify displayline11 prefix {"translate":"scoreboard.TropicalPunch","with":[{"translate":"scoreboard.TropicalPunch.Symbol","color":"#0088ff"}]}
    # Red team
execute as @a[tag=ingame,tag=!16dead,team=red] run team modify displayline8 prefix {"translate":"scoreboard.TropicalPunch","with":[{"translate":"scoreboard.TropicalPunch.Symbol","color":"gray"}]}
execute as @a[tag=ingame,tag=16dead,team=red] run team modify displayline8 prefix {"translate":"scoreboard.TropicalPunch","with":[{"translate":"scoreboard.TropicalPunch.Symbol","color":"red"}]}
    # Green team
execute as @a[tag=ingame,tag=!16dead,team=green] run team modify displayline5 prefix {"translate":"scoreboard.TropicalPunch","with":[{"translate":"scoreboard.TropicalPunch.Symbol","color":"gray"}]}
execute as @a[tag=ingame,tag=16dead,team=green] run team modify displayline5 prefix {"translate":"scoreboard.TropicalPunch","with":[{"translate":"scoreboard.TropicalPunch.Symbol","color":"green"}]}
    # Orange team
execute as @a[tag=ingame,tag=!16dead,team=orange] run team modify displayline2 prefix {"translate":"scoreboard.TropicalPunch","with":[{"translate":"scoreboard.TropicalPunch.Symbol","color":"gray"}]}
execute as @a[tag=ingame,tag=16dead,team=orange] run team modify displayline2 prefix {"translate":"scoreboard.TropicalPunch","with":[{"translate":"scoreboard.TropicalPunch.Symbol","color":"gold"}]}