...
# Displays specific symbols that represent if the player has finished depending on if they have the finished tag
    # Blue team
execute as @a[tag=ingame,tag=!finished,team=blue] run team modify displayline11 prefix {"translate":"scoreboard.FlagFracas","with":[{"translate":"scoreboard.FlagFracas.Symbol","color":"dark_gray"}]}
execute as @a[tag=ingame,tag=finished,team=blue] run team modify displayline11 prefix {"translate":"scoreboard.FlagFracas","with":[{"translate":"scoreboard.FlagFracas.Symbol","color":"#0088ff"}]}
    # Red team
execute as @a[tag=ingame,tag=!finished,team=red] run team modify displayline8 prefix {"translate":"scoreboard.FlagFracas","with":[{"translate":"scoreboard.FlagFracas.Symbol","color":"dark_gray"}]}
execute as @a[tag=ingame,tag=finished,team=red] run team modify displayline8 prefix {"translate":"scoreboard.FlagFracas","with":[{"translate":"scoreboard.FlagFracas.Symbol","color":"red"}]}
    # Green team
execute as @a[tag=ingame,tag=!finished,team=green] run team modify displayline5 prefix {"translate":"scoreboard.FlagFracas","with":[{"translate":"scoreboard.FlagFracas.Symbol","color":"dark_gray"}]}
execute as @a[tag=ingame,tag=finished,team=green] run team modify displayline5 prefix {"translate":"scoreboard.FlagFracas","with":[{"translate":"scoreboard.FlagFracas.Symbol","color":"green"}]}
    # Orange team
execute as @a[tag=ingame,tag=!finished,team=orange] run team modify displayline2 prefix {"translate":"scoreboard.FlagFracas","with":[{"translate":"scoreboard.FlagFracas.Symbol","color":"dark_gray"}]}
