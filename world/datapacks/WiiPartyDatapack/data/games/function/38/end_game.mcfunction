...
schedule function games:38/end 5s
...
scoreboard players reset ingame= 38scores

# Gives placement tags
function games:38/give_score

# Runs the function that shows where the players placed
execute unless score practice= 38scores matches 1 run function general:placements
...
execute if score practice= 38scores matches 1 run tellraw @a[tag=ingame,team=blue] {"nbt":"colors.blue","storage":"minecraft:config","interpret":true,"extra":[{"translate":"generic.Practice.RoundOver","bold":true}],"source":"storage","type":"nbt"}
execute if score practice= 38scores matches 1 run tellraw @a[tag=ingame,team=red] {"nbt":"colors.red","storage":"minecraft:config","interpret":true,"extra":[{"translate":"generic.Practice.RoundOver","bold":true}],"source":"storage","type":"nbt"}
execute if score practice= 38scores matches 1 run tellraw @a[tag=ingame,team=green] {"nbt":"colors.green","storage":"minecraft:config","interpret":true,"extra":[{"translate":"generic.Practice.RoundOver","bold":true}],"source":"storage","type":"nbt"}
execute if score practice= 38scores matches 1 run tellraw @a[tag=ingame,team=orange] {"nbt":"colors.orange","storage":"minecraft:config","interpret":true,"extra":[{"translate":"generic.Practice.RoundOver","bold":true}],"source":"storage","type":"nbt"}

# Restarts vote if practice mode is on
execute if score practice= 38scores matches 1 run schedule function games:38/start 112t
