...
execute if score continue= 38scores matches 1 run function games:38/gallery/internal/blue
execute if score continue= 38scores matches 0 run function games:38/gallery/red