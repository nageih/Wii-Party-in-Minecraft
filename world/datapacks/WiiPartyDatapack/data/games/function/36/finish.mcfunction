...
# Last place
execute store result score players= 36scores if entity @a[tag=ingame]
execute if score players= 36scores matches 4 run tag @a[tag=ingame,tag=!36finished] add 4th
execute if score players= 36scores matches 3 run tag @a[tag=ingame,tag=!36finished] add 3rd
execute if score players= 36scores matches 2 run tag @a[tag=ingame,tag=!36finished] add 2nd
...
schedule function games:36/end 5s
