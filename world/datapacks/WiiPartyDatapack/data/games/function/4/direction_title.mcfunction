...
# Blue 
    # Left
title @s[tag=4left,team=blue] actionbar {"nbt":"colors.blue","storage":"minecraft:config","interpret":true,"extra":[{"text":"◀◀ ","bold":true,"type":"text"},{"text":" ","type":"text"},{"translate":"game.BackAttack.Turning","bold":false,"underlined":true},{"translate":"game.BackAttack.Left","underlined":true},{"text":" ","type":"text"},{"text":" ◀◀","type":"text"}],"source":"storage","type":"nbt"}
    # Right
title @s[tag=4right,team=blue] actionbar {"nbt":"colors.blue","storage":"minecraft:config","interpret":true,"extra":[{"text":"▶▶ ","bold":true,"type":"text"},{"text":" ","type":"text"},{"translate":"game.BackAttack.Turning","bold":false,"underlined":true},{"translate":"game.BackAttack.Right","underlined":true},{"text":" ","type":"text"},{"text":" ▶▶","type":"text"}],"source":"storage","type":"nbt"}
# Red 
    # Left
title @s[tag=4left,team=red] actionbar {"nbt":"colors.red","storage":"minecraft:config","interpret":true,"extra":[{"text":"◀◀ ","bold":true,"type":"text"},{"text":" ","type":"text"},{"translate":"game.BackAttack.Turning","bold":false,"underlined":true},{"translate":"game.BackAttack.Left","underlined":true},{"text":" ","type":"text"},{"text":" ◀◀","type":"text"}],"source":"storage","type":"nbt"}
    # Right
