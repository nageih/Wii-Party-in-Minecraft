...
execute if score countdownTimer= lobby matches 120 run function lobby:minis/play

execute if score countdownTimer= lobby matches 120 run scoreboard players set countdownMinigame= lobby 0
