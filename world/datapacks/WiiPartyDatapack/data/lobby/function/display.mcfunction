...
team modify displayline10 prefix [{"translate":"lobby.Display.Welcome.1"}]
team modify displayline9 prefix [{"translate":"lobby.Display.Welcome.2","with":[{"translate":"generic.Name","bold":false}]}]

team modify displayline8 prefix [{"translate":"lobby.Display.Join1"}]
team modify displayline7 prefix [{"translate":"lobby.Display.Join2"}]
