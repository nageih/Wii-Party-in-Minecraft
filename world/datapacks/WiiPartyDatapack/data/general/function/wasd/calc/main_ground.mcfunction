...
tag @s remove moveForwards
tag @s remove moveLeft
tag @s remove moveRight
tag @s remove moveBackwards
...
execute if score y local.wasd_out >= threshold_bottom local.wasd_var run tag @s add moveForwards
execute if score x local.wasd_out <= threshold_top local.wasd_var run tag @s add moveLeft
execute if score y local.wasd_out <= threshold_top local.wasd_var run tag @s add moveBackwards
execute if score x local.wasd_out >= threshold_bottom local.wasd_var run tag @s add moveRight

#execute if entity @s[tag=moveForwards] run say forward
#execute if entity @s[tag=moveLeft] run say left
#execute if entity @s[tag=moveRight] run say right
#execute if entity @s[tag=moveBackwards] run say backwards
